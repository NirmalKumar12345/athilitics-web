...
const PopupCard: React.FC<PopupCardProps> = ({ onClose }) => {
  return (
    <div className="w-full max-w-[531px] mx-auto px-4 sm:px-6 md:px-0">
      <div className="h-[180px] sm:h-[200px] md:h-[226px] bg-[#4EF162] rounded-tl-[10px] rounded-tr-[10px] relative flex flex-col items-center justify-center p-4 sm:p-6 md:p-0">
        ...
        <img src="/images/success.svg" alt="Success" className="w-[60px] h-[60px] sm:w-[80px] sm:h-[80px] md:w-[95px] md:h-[94.12px] mb-3 sm:mb-4" />
